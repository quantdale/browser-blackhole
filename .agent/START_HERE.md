...
1. `openspec/changes/m12-neutron-star-surface-lensing/`
2. `openspec/changes/m12-repository-integrity/`
3. `openspec/changes/ca9-galaxy-collision/`
...
From repository root, after reading the active change:
