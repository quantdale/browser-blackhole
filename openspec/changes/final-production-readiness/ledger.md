...
| F-04 | P3 | docs | Control-plane docs marked "campaign complete" while `main` CI red — repository/CI/release state disagreed. | Prior campaign closure did not gate on hosted CI going green. | Certification report + doc sync gate completion on hosted green. | Certification report cites green runs. | OPEN — closes at certification |
